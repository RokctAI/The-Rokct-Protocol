...
class Jurisdiction:
    ...
    def __init__(
        ...
        self.registry_document = registry_document or "Business Registration Certificate"
...
_REGISTRY = {
    ...
    "NA": Jurisdiction(
        ...
        registry_name="BIPA", tax_authority="NamRA", aliases=("namibia",),
    ),
    "BW": Jurisdiction(
        code="BW", name="Botswana", currency="BWP", currency_symbol="P",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="CIPA", tax_authority="BURS", aliases=("botswana",),
    ),
    "ZW": Jurisdiction(
        code="ZW", name="Zimbabwe", currency="USD", currency_symbol="US$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="Companies Registry", tax_authority="ZIMRA", aliases=("zimbabwe",),
    ),
    "KE": Jurisdiction(
        code="KE", name="Kenya", currency="KES", currency_symbol="KSh",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="Business Registration Service", tax_authority="KRA",
        privacy_law="Data Protection Act 2019", aliases=("kenya",),
    ),
    "NG": Jurisdiction(
        code="NG", name="Nigeria", currency="NGN", currency_symbol="₦",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="CAC", tax_authority="FIRS",
        privacy_law="NDPA", aliases=("nigeria",),
    ),
    "GH": Jurisdiction(
        code="GH", name="Ghana", currency="GHS", currency_symbol="GH₵",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="Registrar General's Department", tax_authority="GRA",
        aliases=("ghana",),
    ),
    "US": Jurisdiction(
        code="US", name="United States", currency="USD", currency_symbol="$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS),
        registry_name="Secretary of State", registry_document="Certificate of Incorporation",
        tax_authority="IRS", privacy_law="CCPA/CPRA", standards_body="ANSI",
        default_entity_suffix="LLC",
        aliases=("united states", "united states of america", "usa", "u.s.a.", "america"),
    ),
    "CA": Jurisdiction(
        code="CA", name="Canada", currency="CAD", currency_symbol="C$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="Corporations Canada", tax_authority="CRA",
        privacy_law="PIPEDA", standards_body="CSA", aliases=("canada",),
    ),
    "GB": Jurisdiction(
        code="GB", name="United Kingdom", currency="GBP", currency_symbol="£",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="Companies House", registry_document="Certificate of Incorporation",
        tax_authority="HMRC", privacy_law="UK GDPR", standards_body="BSI",
        default_entity_suffix="Ltd",
        aliases=("united kingdom", "uk", "great britain", "england", "scotland", "wales"),
    ),
    "IE": Jurisdiction(
        code="IE", name="Ireland", currency="EUR", currency_symbol="€",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="CRO", tax_authority="Revenue", privacy_law="GDPR",
        default_entity_suffix="Ltd", aliases=("ireland", "republic of ireland"),
    ),
    "DE": Jurisdiction(
        code="DE", name="Germany", currency="EUR", currency_symbol="€",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="Handelsregister", registry_document="Handelsregisterauszug",
        tax_authority="Finanzamt", privacy_law="GDPR", standards_body="DIN",
        default_entity_suffix="GmbH", aliases=("germany", "deutschland"),
    ),
    "FR": Jurisdiction(
        code="FR", name="France", currency="EUR", currency_symbol="€",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="RCS", registry_document="Extrait Kbis",
        tax_authority="DGFiP", privacy_law="GDPR", standards_body="AFNOR",
        default_entity_suffix="SAS", aliases=("france",),
    ),
    "NL": Jurisdiction(
        code="NL", name="Netherlands", currency="EUR", currency_symbol="€",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="KvK", tax_authority="Belastingdienst", privacy_law="GDPR",
        standards_body="NEN", default_entity_suffix="B.V.",
        aliases=("netherlands", "holland", "the netherlands"),
    ),
    "AE": Jurisdiction(
        code="AE", name="United Arab Emirates", currency="AED", currency_symbol="AED",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_VAT),
        registry_name="DED", tax_authority="FTA", default_entity_suffix="LLC",
        aliases=("united arab emirates", "uae", "dubai", "abu dhabi"),
    ),
    "IN": Jurisdiction(
        code="IN", name="India", currency="INR", currency_symbol="₹",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="MCA", registry_document="Certificate of Incorporation",
        tax_authority="Income Tax Department", privacy_law="DPDP Act",
        standards_body="BIS", default_entity_suffix="Pvt Ltd", aliases=("india",),
    ),
    "AU": Jurisdiction(
        code="AU", name="Australia", currency="AUD", currency_symbol="A$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="ASIC", tax_authority="ATO", privacy_law="Privacy Act",
        standards_body="Standards Australia", default_entity_suffix="Pty Ltd",
        aliases=("australia",),
    ),
    "NZ": Jurisdiction(
        code="NZ", name="New Zealand", currency="NZD", currency_symbol="NZ$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="NZ Companies Office", tax_authority="IRD",
        default_entity_suffix="Limited", aliases=("new zealand",),
    ),
    "SG": Jurisdiction(
        code="SG", name="Singapore", currency="SGD", currency_symbol="S$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TRADEMARKS, FEATURE_VAT),
        registry_name="ACRA", tax_authority="IRAS", privacy_law="PDPA",
        default_entity_suffix="Pte Ltd", aliases=("singapore",),
    ),
    "BR": Jurisdiction(
        code="BR", name="Brazil", currency="BRL", currency_symbol="R$",
        features=(FEATURE_COMPANY_REGISTRY, FEATURE_TAX_CLEARANCE, FEATURE_VAT),
        registry_name="Junta Comercial", tax_authority="Receita Federal",
        privacy_law="LGPD", default_entity_suffix="Ltda", aliases=("brazil", "brasil"),
    ),
}
...
def entity_suffix_for(jurisdiction, registration_number):
    ...
    if not registration_number or not jurisdiction.entity_suffix_by_code:
        return None
    match = re.search(r"(\d{4})\s*/\s*(\d{6,7})\s*/\s*(\d{2})", str(registration_number))
    if not match:
        return None
