...
Fetches update_status.py from GitHub, executes it.
"""
...
DELEGATE_PATH   = "core/utils/agent_deligation/update_status.py"
...
def main():
    ...
    if not code:
        print("Error: update_status.py not found on GitHub.", file=sys.stderr)
        sys.exit(1)
