...
Fetches update_dashboard.py from GitHub, executes it.
"""
...
DELEGATE_PATH   = "core/utils/agent_deligation/update_dashboard.py"
...
def main():
    ...
    if not code:
        print("Error: update_dashboard.py not found on GitHub.", file=sys.stderr)
        sys.exit(1)
