...
Fetches reporter.py from GitHub, executes it with the dashboard subcommand.
"""
...
def main():
    ...
    try:
        result = subprocess.run([sys.executable, tmp_path, "dashboard"] + sys.argv[1:], check=False)
