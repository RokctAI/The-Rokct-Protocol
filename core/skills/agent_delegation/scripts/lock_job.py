...
Fetches lock_job.py from GitHub, executes it.
"""
...
DELEGATE_PATH   = "core/utils/agent_deligation/lock_job.py"
...
def main():
    ...
    if not code:
        print("Error: lock_job.py not found on GitHub.", file=sys.stderr)
        sys.exit(1)
