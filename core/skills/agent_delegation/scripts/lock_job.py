...
#!/usr/bin/env python3
"""
The-Rokct-Protocol scaffold: lock_job.py
Fetches job_manager.py from GitHub pinned to PROTOCOL_REF, verifies its
SHA-256, then executes it with the lock subcommand.
"""
...
DELEGATE_SHA256 = "868defca630cce47d15b7597539ea2aeeeff035533683973eb9871c16307d1fd"
GITHUB_RAW_BASE = (
...
def main():
    ...
    try:
        result = subprocess.run(
            [sys.executable, tmp_path, "lock"] + sys.argv[1:], check=False
        )
